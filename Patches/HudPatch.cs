            ...
            if (player.IsAlive())
            {
                ...
                switch (player.GetCustomRole())
                {
                    ...
                    case CustomRoles.Strikers :
                        __instance.KillButton.OverrideText(GetString("StrikersButtonText"));
                        break;
                    ...
                    case CustomRoles.Swapper:
                        __instance.KillButton.OverrideText(GetString("jhsKillButtonText"));
                        break;
                    ...
                    case CustomRoles.Bomber:
                        __instance.KillButton.OverrideText(GetString("BomberShapeshiftText"));
                        break;
                    case CustomRoles.Vulture:
                        __instance.ReportButton.OverrideText(GetString("VultureReportButtonText"));
                        break;
                    case CustomRoles.Amnesiac:
                        __instance.ReportButton.OverrideText(GetString("syzButtonText"));
                        break;
                    case CustomRoles.Jackal:
                        Jackal.SetKillButtonText(player.PlayerId);
                        break;
                    case CustomRoles.Prophet:
                        __instance.KillButton.OverrideText(GetString("ProphetButtonText"));
                        break;
                    case CustomRoles.Scout:
                        __instance.KillButton.OverrideText(GetString("ScoutButtonText"));
                        break;
                    case CustomRoles.StinkyAncestor:
                         __instance.AbilityButton.buttonLabelText.text = GetString("StinkyAncestorVetnButtonText");
                        break;
                    case CustomRoles.Deputy:
                        __instance.KillButton.OverrideText(GetString("DeputyButtonText"));
                        break;
                    case CustomRoles.QSR:
                        __instance.KillButton.OverrideText(GetString("QSRButtonText"));
                        break;
                    case CustomRoles.TimeStops:
                        __instance.AbilityButton.buttonLabelText.text = GetString("TimeStopsVetnButtonText");
                        break;
                    case CustomRoles.Grenadiers:
                        __instance.AbilityButton.OverrideText(GetString("GrenadierVetnButtonText"));
                        break;
                    case CustomRoles.TimeMaster:
                        __instance.AbilityButton.buttonLabelText.text = GetString("TimeMasterVetnButtonText");
                        break;
                    ...
                    case CustomRoles.Spellmaster:
                        if (Main.SpellmasterMax[player.PlayerId] >= Options.SpellmasterKillMax.GetInt())
                        {
                            __instance.KillButton.OverrideText(GetString("KillButtonText"));
                        }
                        else
                        {
                            __instance.KillButton.OverrideText(GetString("SpellmasterButtonText"));
                        }
                        break;
                    case CustomRoles.GlennQuagmire:
                        __instance.AbilityButton.buttonLabelText.text = GetString("GlennQuagmireVetnButtonText");
                        break;
                    case CustomRoles.SoulSeeker:
                        __instance.AbilityButton.buttonLabelText.text = GetString("SoulSeekerVetnButtonText");
                        break;
                    ...
                    case CustomRoles.Captain:
                        __instance.KillButton.OverrideText(GetString("CaptainKillButtonText"));
                        break;
                    case CustomRoles.ET:
                        __instance.KillButton.OverrideText(GetString("ETKillButtonText"));
                        break;
                    case CustomRoles.King:
                        __instance.KillButton.OverrideText(GetString("KingKillButtonText"));
                        break;
                    ...
                    case CustomRoles.Exorcist:
                        __instance.KillButton.OverrideText(GetString("ExorcistKillButtonText"));
                        break;
...
class VentButtonDoClickPatch
{
    public static bool Prefix(VentButton __instance)
    {
        ...
        if (pc.GetCustomRole() is CustomRoles.Swooper or CustomRoles.Arsonist or CustomRoles.Revolutionist or CustomRoles.Veteran or CustomRoles.Paranoia or CustomRoles.Mayor or CustomRoles.Grenadier or CustomRoles.DovesOfNeace or CustomRoles.Rudepeople or CustomRoles.StinkyAncestor or CustomRoles.TimeStops or CustomRoles.TimeMaster)
        {
...
class MapBehaviourShowPatch
{
    public static void Prefix(MapBehaviour __instance, ref MapOptions opts)
    {
        ...
        if (opts.Mode is MapOptions.Modes.Normal or MapOptions.Modes.Sabotage)
        {
            ...
            if (player.Is(CustomRoleTypes.Impostor) || (player.Is(CustomRoles.ET)))
                opts.Mode = MapOptions.Modes.Sabotage;
            else
